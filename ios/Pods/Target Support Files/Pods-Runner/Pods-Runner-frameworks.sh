...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_flutter/amplify_flutter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/amplify_storage_s3/amplify_storage_s3.framework"
